...
- [apps/web/src/components/KnowledgeCenter.tsx:1-337](file://apps/web/src/components/KnowledgeCenter.tsx#L1-L337)
...
- [apps/web/src/api.ts:1-654](file://apps/web/src/api.ts#L1-L654)
- [apps/web/src/styles.css:1-2981](file://apps/web/src/styles.css#L1-L2981)
...
- [apps/web/src/api.ts:434-654](file://apps/web/src/api.ts#L434-L654)
...
- [apps/web/src/api.ts:487-654](file://apps/web/src/api.ts#L487-L654)
...
- [apps/web/src/styles.css:2945-2981](file://apps/web/src/styles.css#L2945-L2981)
...
- 与组件的耦合
  ...
  - Markdown渲染器和Mermaid图表完全基于 CSS 变量，支持无缝主题切换。
